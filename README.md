...
End-to-End Insurance Claims Analytics | Excel • SQL • Snowflake • Python • Databricks • PySpark • Machine Learning • Power BI • Streamlit • GitHub
...
Connects agents/employees with claims

Vendor → Insurance

VENDOR_ID

Connects vendors with claims
...
Invalid non-null Vendor References

0

Policy Effective Date > Loss Date
...
Days between loss date and report date
...
Claim amount categorization

REPORTING_CATEGORY

Reporting delay categorization

CLAIM_VALUE_CATEGORY

Claim value categorization
...
Month from loss date

LOSS_MONTH_NAME

Month name from loss date
...
Reporting delay, same-day reporting

Agent

Claim volume and exposure
...
Unique Non-null Vendors in Claims
...
Level/category of loss associated with the incident
...
Overall claims and financial exposure

KPIs, monthly trend, insurance type, premium

02 - Risk & Severity

Risk and incident severity

Risk, severity, risk × severity, exposure, age

03 - Operations & Investigation

Operational claim behavior

Reporting delay, high-value claims, agent/vendor exposure
...
Claim amount prediction and model results
...
Validation, cleaning, transformation, analysis
...
Python/PySpark analytics environment
...
Raw insurance, employee and vendor data
...
Creates database objects and environment

02_Raw_Data_Validation.sql

Raw Validation

Validates raw datasets
...
Agent-level claim exposure

VENDOR_PERFORMANCE_VW

Vendor-level claim exposure
...
State-level claim analysis

CLAIM_INVESTIGATION_PRIORITY_VW

Rule-based investigation analysis
...
Average ₹16,563.83 vs median ₹7,000, indicating a right-skewed distribution

Risk

1,455 claims are categorized as High Risk

Severity

Claims are distributed across Minor, Major and Total Loss

Reporting

Reporting delays range from 0 to 5 days

Same-Day Reporting

1,565 claims were reported on the same day

Agents

Agent-level analysis shows claim volume and financial exposure

Vendors

Vendor-level analysis shows claim volume and financial exposure

Prediction

Linear Regression achieved R² of 0.7066 on the test set
...
No explicit fraud label

Dataset does not contain a dedicated fraud target

No supervised fraud model

Fraud classification was therefore not implemented

Diagnostic analysis

Identifies patterns but does not prove causation

Agent/Vendor exposure

Exposure alone does not establish service quality

ML predictions

Predictions are estimates, not guaranteed claim values

Missing Vendor IDs

Retained when reliable information was unavailable

Model performance

Depends on the available dataset and test split
...
Store securely outside source code
...
Excluded from analytical outputs
...
Profiling, Cleaning, Transformation, EDA, Diagnostic Analysis, Business Analysis

SQL

Validation, Cleaning, Joins, GroupBy, Aggregations, CASE, Date Functions, Views
...
Regression, Feature Selection, Encoding, Imputation, MAE, RMSE, R²

Power BI

KPI Cards, Slicers, Charts, Dashboards, Business Reporting

Snowflake

Cloud Data Warehouse, SQL Analytics, Analytical Views

Databricks

Notebook analytics and Snowflake integration
...
Interactive filters, KPIs, charts, ML integration

Git/GitHub

Version control, repository organization, documentation
...
The final solution combines Excel, Snowflake SQL, Python, Databricks, PySpark, Machine Learning, Power BI, Streamlit, and GitHub to transform raw insurance claims data into a structured analytics solution for understanding claims behavior, risk, severity, financial exposure, reporting patterns, and claim amount estimation.
